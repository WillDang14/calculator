        ...
        if (value == "clear") {
            ...
            if ( 
				...
				if ( input_array[input_array_length-1] == ")" ) {
					...
					// trường hợp mà nếu phần tử cuối cùng trước khi bấm bracket mà là các phép toán "+ - * /" thì thêm ngoặc mở "("
					// còn lại (là số, number) thì thêm ngoặc đóng
					if (
				...
				// My code để đảm bảo là trước khi đóng ngoặc phải có number sau các operator
				// Code cũ là không có number thì vẫn đóng ngoặc được
				let input_array = input.split("");
